...
def get_token():
    url = 'https://apis.asdoctor.net/internetHospitalWs/getToken/getToken'
    params = {
        "entity": {"diagnosName": "", "livingId": "", "name": phone, "startJoinTime": "", "endJoinTime": ""},
        "paging": {"pageNow": 1, "pageSize": 10}
    }
    res = requests.post(url=url, json=params).json()
    return res["data"]["list"][0]["userId"]
...
service_dict = {
    ...
    "chest-doctor-ws": "https://chestapi.pptooo.com/doctorWs/doc.html",
